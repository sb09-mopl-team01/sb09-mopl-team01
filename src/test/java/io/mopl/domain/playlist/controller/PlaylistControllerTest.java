...
class PlaylistControllerTest {
  ...
  void updatePlaylist() {
    ...
    ResponseEntity<Void> response = playlistController.updatePlaylist(mockUserDetails, playlistId, request);
  ...
  void deletePlaylist() {
    ...
    ResponseEntity<Void> response = playlistController.deletePlaylist(mockUserDetails, playlistId);
  ...
  void findPlaylist() {
    ...
    ResponseEntity<PlaylistDto> response = playlistController.findPlaylist(mockUserDetails, playlistId);
  ...
  void findPlaylists() {
    ...
    given(playlistService.findPlaylists(
        eq(userId), any(), any(), any(), any(), any(), eq(10), eq("DESCENDING"), eq("updatedAt")
    )).willReturn(fakeResponse);

    ResponseEntity<CursorResponse<PlaylistDto>> response = playlistController.findPlaylists(
        mockUserDetails, null, null, null, null, null, 10, "DESCENDING", "updatedAt"
    );
  ...
  void subscribe() {
    ...
    ResponseEntity<Void> response = playlistController.subscribePlaylist(mockUserDetails, playlistId);
